...
declare namespace GatsbyTypes {
  ...
  type File = Node & {
    ...
    readonly childrenTranslationYaml: Maybe<
      ReadonlyArray<Maybe<TranslationYaml>>
    >;
  ...
  /** Field Group */
  type WpPage_Pageacf = {
    readonly boardMembers: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_boardMembers>>
    >;
    ...
    readonly sponsorsContent: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_sponsorsContent>>
    >;
  ...
  type WpPage_Pageacf_Shop = {
    ...
    readonly downloads: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_Shop_downloads>>
    >;
    readonly fieldGroupName: Maybe<Scalars["String"]>;
    readonly info: Maybe<Scalars["String"]>;
    readonly products: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_Shop_products>>
    >;
  };
  ...
  type WpPage_Pageacf_StandardContent = {
    ...
    /** OPTIONAL: Downloads */
    readonly downloads: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_StandardContent_downloads>>
    >;
  ...
  type WpPage_Pageacf_TeamContent = {
    readonly fieldGroupName: Maybe<Scalars["String"]>;
    readonly ranking: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_TeamContent_ranking>>
    >;
  ...
  type WpPage_Pageacf_TeamContent_Team = {
    ...
    readonly fieldGroupName: Maybe<Scalars["String"]>;
    readonly teamMembers: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_TeamContent_Team_teamMembers>>
    >;
  };
  ...
  type WpPage_Pageacf_TicketsContent = {
    ...
    readonly seating: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_TicketsContent_seating>>
    >;
    readonly standing: Maybe<
      ReadonlyArray<Maybe<WpPage_Pageacf_TicketsContent_standing>>
    >;
  ...
  type WpPage_Pageacf_TicketsContent_Seasonpass = {
    readonly applications: Maybe<
      ReadonlyArray<
        Maybe<WpPage_Pageacf_TicketsContent_Seasonpass_applications>
      >
    >;
    readonly description: Maybe<Scalars["String"]>;
    readonly fieldGroupName: Maybe<Scalars["String"]>;
  ...
  type DefaultPageDataFieldsFragment = Pick<WpPage, "content"> & {
    readonly pageACF: Maybe<
      Pick<WpPage_Pageacf, "division"> & {
        readonly standardContent: Maybe<
          ContactFragment & AdditionalInfoFragment & DownloadsFragment
        >;
      }
    >;
  };
  ...
  type ContactFragment = {
    readonly contact: Maybe<
      Pick<
        WpPage_Pageacf_StandardContent_Contact,
  ...
  type AdditionalInfoFragment = {
    readonly additionalInfo: Maybe<
      Pick<WpPage_Pageacf_StandardContent_AdditionalInfo, "title" | "content">
    >;
  };

  type DownloadsFragment = {
    readonly downloads: Maybe<
      ReadonlyArray<
        Maybe<{
          readonly file: Maybe<Pick<WpMediaItem, "mediaItemUrl" | "title">>;
        }>
      >
    >;
  };
  ...
  type SeoFragment = {
    readonly pageACF: Maybe<{ readonly seo: Maybe<SeoFieldsFragment> }>;
  };

  type SeoFieldsFragment = Pick<
    WpPage_Pageacf_Seo,
    | "metaDescription"
    | "noIndex"
    | "ogDescription"
    ...
    | "twitterDescription"
  > & {
    readonly socialImage: Maybe<{
      readonly localFile: Maybe<Pick<File, "url">>;
    }>;
  };
  ...
  type GetSocialLinksQuery = {
    readonly socialLinks: Maybe<{
      readonly homeACF: Maybe<
        Pick<WpPage_Homeacf, "facebookLink" | "instagramLink" | "tickarooLink">
      >;
    }>;
  };
              ...
              Maybe<
                Pick<WpMenuItem, "id" | "label" | "url" | "parentId"> & {
                  readonly childItems: Maybe<{
                    readonly nodes: Maybe<
                      ReadonlyArray<
                        Maybe<Pick<WpMenuItem, "id" | "label" | "url">>
                      >
                    >;
                  }>;
                }
  ...
  type GetHockeyDataQuery = {
    readonly hockeyData: Maybe<Pick<WpPage, "title">>;
    readonly defaultData: Maybe<DefaultPageDataFieldsFragment>;
    readonly seoData: Maybe<SeoFragment>;
  };
  ...
  type GetHomeDataQuery = {
    readonly homeData: Maybe<Pick<WpPage, "title">>;
    readonly postsData: {
      readonly nodes: ReadonlyArray<BlogPostPreviewFieldsFragment>;
    };
    readonly seoData: Maybe<SeoFragment>;
  };
  ...
  type GetGamepitchDataQuery = {
    readonly gamepitchData: Maybe<Pick<WpPage, "title">>;
    readonly defaultData: Maybe<DefaultPageDataFieldsFragment>;
    readonly seoData: Maybe<SeoFragment>;
  };
  ...
  type GetLineupBoardDataQuery = {
    readonly wpPage: Maybe<Pick<WpPage, "title">>;
    readonly defaultData: Maybe<DefaultPageDataFieldsFragment>;
    readonly seoData: Maybe<SeoFragment>;
  };

  type BlogPostPreviewFieldsFragment = Pick<
    WpPost,
    "id" | "title" | "uri" | "excerpt" | "date"
  > & {
    readonly postACF: Maybe<Pick<WpPost_Postacf, "division" | "postCategory">>;
    ...
    readonly categories: Maybe<{
      readonly nodes: Maybe<ReadonlyArray<Maybe<Pick<WpCategory, "name">>>>;
    }>;
  };
  ...
  type GetGameReportDataQuery = {
    readonly wpPost: Maybe<Pick<WpPost, "title">>;
  };
  ...
  type GetSponsorsDataQuery = {
    readonly sponsorsData: Maybe<Pick<WpPage, "title">>;
    readonly defaultData: Maybe<DefaultPageDataFieldsFragment>;
    readonly seoData: Maybe<SeoFragment>;
  };
  ...
  type GetTranslationQuery = {
    readonly translationYaml: Maybe<
      Pick<TranslationYaml, "contact" | "menu"> & {
        readonly test: Maybe<
          ReadonlyArray<Maybe<Pick<TranslationYamlTest, "property">>>
        >;
      }
    >;
  };
  ...
  type GetLineupDataQuery = {
    readonly lineupData: Maybe<Pick<WpPage, "title">>;
    readonly defaultData: Maybe<DefaultPageDataFieldsFragment>;
    readonly seoData: Maybe<SeoFragment>;
  };
}
